...
function findAlerts(curSuite, prevSuite, threshold, checkHostName) {
...
async function handleAlert(benchName, curSuite, prevSuite, config) {
    const { alertThreshold, githubToken, commentOnAlert, failOnAlert, alertCommentCcUsers, failThreshold, checkHostName, } = config;
